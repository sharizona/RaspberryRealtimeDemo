...
echo "  1. Basic Pthread (SCHED_OTHER):        cd examples/01_basic_pthread && make run"\n\
echo "  2. Real-Time Pthread (SCHED_FIFO):     cd examples/02_realtime_pthread && make run"\n\
echo "  3. Scheduling Comparison:              cd examples/03_scheduling_comparison && make run"\n\
echo "  4. Priority Inversion Demo:            cd examples/04_priority_inversion && make run"\n\
echo ""\n\
...
echo ""\n\
echo "Compiling and executing happens automatically inside this container."\n\
echo ""\n\
